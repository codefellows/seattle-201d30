...
This will be a pair-programming project; at any point in time, one of you will be the driver, and one will be the navigator. Be sure to switch so you have equal time in each role.
---

**GitHub Repository & Project Setup**

Create a new repository for today called **chocolate-pizza**. Whoever created the repository will add the other partner as a collaborator to that repo. Be sure to do frequent commits, and always do your work on branches. Before starting coding, think about a strategy for approaching this project. Before writing code, think about a practical order in which to do the work:
...
- When you should you add JS? Do you even add JS? (Hint: JS is not part of your MVP.)
...
Add a brief explanation to the README stating:
...
Submit: You'll be committing regularly and working on branches for additional Git practice. Both partners submit the link to the most recent pull request into the Canvas assignment.
